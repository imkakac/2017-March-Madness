...
if __name__ == "__main__":
    ...
    with open(folder + '/submission.csv', 'w', newline = '') as f:
        writer = csv.writer(f)
    ...
    with open(folder + '/readable-predictions.csv', 'w', newline = '') as f:
        writer = csv.writer(f)
        writer.writerows(readable)
    with open(folder + '/less-readable-predictions.csv', 'w', newline = '') as f:
        writer = csv.writer(f)
